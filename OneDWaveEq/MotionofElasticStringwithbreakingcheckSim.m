...
k_internal = 0.6; % Internal damping coefficient (reduced)
...
for n = 2:Nt-1
    % Interior points
    u(2:Nx-1,n+1) = (2-2*CFL^2-k_internal*dt)*u(2:Nx-1,n) + ...
                    (CFL^2-k_air*dt*abs(u(2:Nx-1,n)-u(2:Nx-1,n-1))/dt).*(u(3:Nx,n)+u(1:Nx-2,n)) + ...
                    (-1+k_internal*dt+k_air*dt*abs(u(2:Nx-1,n)-u(2:Nx-1,n-1))/dt).*u(2:Nx-1,n-1);
